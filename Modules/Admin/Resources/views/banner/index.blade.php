...
<div class="container-fluid ">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mg-b-20 mg-lg-b-25 mg-xl-b-30">
        ...
        <div>
            ...
            <a href="{{route('addbanner')}}" id="sample_editable_1_new" class="btn btn-outline-success" data-toggle="modal1" data-target="#modalEditContact"> Add New
            </a>
        </div>
    </div>
    ...
    <table id="example2" class="table tx-center display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr id="example">
                ...
                <td> <img style="height:80px; width:100px; border-radius:50%;" src=" {{asset('/images/bannerImage/'.$data['banner_image'])}}"></td>
                <td>
                    <input type="checkbox" class="rwd_status" data-reward_id="{{$data['id']}}" @if ($data['is_active']==1) checked @endif data-toggle="toggle" data-on="Active" data-off="Inactive" data-onstyle="primary" data-offstyle="warning">
                </td>
                <td> {{$data['date_created']}}</td>
                <td>
                    <a href="{{url('/admin/banner/edit/'.$data['id'])}}" class="tx-success"><i data-feather="edit-2"></i></a>
                    <a href="{{url('/admin/banner/destroy/'.$data['id'])}}" class="tx-danger" data_id="{{$data['id']}}"><i data-feather="trash"></i></a>
                </td>
                @endforeach
                @endif
                @endif

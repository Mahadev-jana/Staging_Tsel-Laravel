    ...
    <div class="row row-xs">
        ...
        <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="datetime-local" class="form-control" name="start_date" id="prediction_start" value="{{old('start_date')}}" >
        ...
        <div class="col-lg-12">
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="datetime-local" class="form-control" name="end_date" id="prediction_end" value="{{old('end_date')}}" >
                    @error('end_date')

    ...
    <table id="example2" class="table tx-center display" cellspacing="0" width="100%">
        ...
        <tbody>
            ...
            <tr id="example">
                ...
                <td> <img style="height:80px; width:100px; border-radius:50%;" src=" {{asset('/images/prizeImage/'.$data['prize_image'])}}"></td>
                ...
                <td>
                    <a href="{{url('/admin/winnermanagment/edit/'.$data['id'])}}" class="tx-success"><i data-feather="edit-2"></i></a>
                    <a href="{{url('/admin/winnermanagment/destroy/'.$data['id'])}}" class="tx-danger" data_id="{{$data['id']}}"><i data-feather="trash"></i></a>
                </td>
                @endforeach
                @endif

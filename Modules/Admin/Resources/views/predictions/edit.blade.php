            ...
            <div class="col-lg-5">
                ...
                <div class="col-lg-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            @php $datee = date("Y-m-d\TH:i:s", strtotime($predictionDetails->prediction_start_time)); @endphp
                            <input type="datetime-local" class="form-control" name="prediction_start" id="prediction_start" value="@php echo $datee @endphp" required>
                            <div class="invalid-feedback mg-b-10">This is required</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            @php $date = date("Y-m-d\TH:i:s", strtotime($predictionDetails->prediction_end_time)); @endphp
                            <input type="datetime-local" class="form-control" name="prediction_end" id="prediction_end" value="@php echo $date @endphp" required>
                            <div class="invalid-feedback mg-b-10">This is required</div>
                        </div>
                    </div>
                </div>

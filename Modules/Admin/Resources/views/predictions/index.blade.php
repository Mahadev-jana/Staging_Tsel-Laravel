            ...
            @foreach($allCompetitions as $Competitions)
              @php  $no++; @endphp
                <tr id="example">
                    <td>{{$no}} </td>
                    <td style="width:13%">
                        <img src="{{$Competitions->home_team_logo}}" alt="Category Image"  height="30"> {{$Competitions->home_team_name}} 
                        VS
                        <img src="{{$Competitions->away_team_logo}}" alt="Category Image"  height="30">
                        {{$Competitions->away_team_name}}
                    </td>
                    ...
                    <input class="pred_status" data-pred_id="{{ $Competitions->id }}"type="checkbox" data-toggle="toggle" data-size="small" 
                    pred-id="{{ $Competitions->id }}" {{ $Competitions->is_active ? 'checked' : '' }}>   
                    ...
                    <td>
                        @if($Competitions->winner_status==0)
                    ...
                    <td>
                    <div>
                    <a href="{{url('/admin/prediction/edit/'.$Competitions->id)}}" class="tx-success"><i data-feather="edit-2"></i></a>
                    <a href="javascript:void(0)" class="tx-danger pred_delete" data-pred_id="{{$Competitions->id}}"><i data-feather="trash"></i></a>
                    </div>
                    </td>
